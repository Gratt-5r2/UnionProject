...
namespace Gothic_I_Classic {
  ...
  public:
    ...
    oCNpcInventory inventory2;                    // sizeof 230h   offset 550h
    oCItemContainer* trader;                      // sizeof 04h    offset 780h
    oCNpc* tradeNpc;                              // sizeof 04h    offset 784h
    float rangeToPlayer;                          // sizeof 04h    offset 788h
    zCArray<int> listOfVoiceHandles;              // sizeof 0Ch    offset 78Ch
    int voiceIndex;                               // sizeof 04h    offset 798h
    ...
    int instanz;                                  // sizeof 04h    offset 7B0h
    zSTRING mds_name;                             // sizeof 14h    offset 7B4h
    zSTRING body_visualName;                      // sizeof 14h    offset 7C8h
    zSTRING head_visualName;                      // sizeof 14h    offset 7DCh
    zVEC3 model_scale;                            // sizeof 0Ch    offset 7F0h
    float model_fatness;                          // sizeof 04h    offset 7FCh
    int namenr;                                   // sizeof 04h    offset 800h
    float hpHeal;                                 // sizeof 04h    offset 804h
    float manaHeal;                               // sizeof 04h    offset 808h
    float swimtime;                               // sizeof 04h    offset 80Ch
    float divetime;                               // sizeof 04h    offset 810h
    float divectr;                                // sizeof 04h    offset 814h
    zCVob* fireVob;                               // sizeof 04h    offset 818h
    int fireDamage;                               // sizeof 04h    offset 81Ch
    float fireDamageTimer;                        // sizeof 04h    offset 820h
    int attitude;                                 // sizeof 04h    offset 824h
    int tmp_attitude;                             // sizeof 04h    offset 828h
    float attTimer;                               // sizeof 04h    offset 82Ch
    int knowsPlayer;                              // sizeof 04h    offset 830h
    TNpcPerc percList[NPC_PERC_MAX];              // sizeof 108h   offset 834h
    int percActive;                               // sizeof 04h    offset 93Ch
    float percActiveTime;                         // sizeof 04h    offset 940h
    float percActiveDelta;                        // sizeof 04h    offset 944h
    int overrideFallDownHeight;                   // sizeof 04h    offset 948h
    float fallDownHeight;                         // sizeof 04h    offset 94Ch
    int fallDownDamage;                           // sizeof 04h    offset 950h
    oCMag_Book* mag_book;                         // sizeof 04h    offset 954h
    zCList<oCSpell> activeSpells;                 // sizeof 08h    offset 958h
    zCArray<zSTRING> activeOverlays;              // sizeof 0Ch    offset 960h
    oCAskBox* askbox;                             // sizeof 04h    offset 96Ch
    int askYes;                                   // sizeof 04h    offset 970h
    int askNo;                                    // sizeof 04h    offset 974h
    float canTalk;                                // sizeof 04h    offset 978h
    oCNpc* talkOther;                             // sizeof 04h    offset 97Ch
    oCInfo* info;                                 // sizeof 04h    offset 980h
    oCNews* news;                                 // sizeof 04h    offset 984h
    oCMission* curMission;                        // sizeof 04h    offset 988h
    oCNewsMemory knownNews;                       // sizeof 0Ch    offset 98Ch
    zCVob* carry_vob;                             // sizeof 04h    offset 998h
    oCMobInter* interactMob;                      // sizeof 04h    offset 99Ch
    oCItem* interactItem;                         // sizeof 04h    offset 9A0h
    int interactItemCurrentState;                 // sizeof 04h    offset 9A4h
    int interactItemTargetState;                  // sizeof 04h    offset 9A8h
    int script_aiprio;                            // sizeof 04h    offset 9ACh
    int old_script_state;                         // sizeof 04h    offset 9B0h
    oCAIHuman* human_ai;                          // sizeof 04h    offset 9B4h
    oCAniCtrl_Human* anictrl;                     // sizeof 04h    offset 9B8h
    zCRoute* route;                               // sizeof 04h    offset 9BCh
    float damageMul;                              // sizeof 04h    offset 9C0h
    oCNpcMessage* csg;                            // sizeof 04h    offset 9C4h
    oCNpcMessage* lastLookMsg;                    // sizeof 04h    offset 9C8h
    oCNpcMessage* lastPointMsg;                   // sizeof 04h    offset 9CCh
    zCArray<zCVob*> vobList;                      // sizeof 0Ch    offset 9D0h
    float vobcheck_time;                          // sizeof 04h    offset 9DCh
    float pickvobdelay;                           // sizeof 04h    offset 9E0h
    zCVob* focus_vob;                             // sizeof 04h    offset 9E4h
    zCArray<TNpcSlot*> invSlot;                   // sizeof 0Ch    offset 9E8h
    zCArray<TNpcSlot*> tmpSlotList;               // sizeof 0Ch    offset 9F4h
    float fadeAwayTime;                           // sizeof 04h    offset A00h
    float respawnTime;                            // sizeof 04h    offset A04h
    float selfDist;                               // sizeof 04h    offset A08h
    int fightRangeBase;                           // sizeof 04h    offset A0Ch
    int fightRangeFist;                           // sizeof 04h    offset A10h
    float fight_waitTime;                         // sizeof 04h    offset A14h
    int fight_waitForAniEnd;                      // sizeof 04h    offset A18h
    float fight_lastStrafeFrame;                  // sizeof 04h    offset A1Ch
    int soundType;                                // sizeof 04h    offset A20h
    zCVob* soundVob;                              // sizeof 04h    offset A24h

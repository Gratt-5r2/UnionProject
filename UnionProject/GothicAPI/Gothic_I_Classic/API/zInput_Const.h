...
#ifndef __ZINPUT__CONST_H__VER0__
#define __ZINPUT__CONST_H__VER0__
...
namespace Gothic_I_Classic {
  ...
  #define KEY_CIRCUMFLEX      KEY_PREVTRACK       
  ...
  #define MIN_MOUSE_BTNS_AND_CODES  (KEY_NOT_HERE)  
  ...
  #define MIN_MOUSE_BTNS            (MOUSE_WHEELUP)  
  #define MAX_MOUSE_BTNS            (MOUSE_XBUTTON5         +  1)
  #define MIN_JOY_BTNS_AND_CODES    (MAX_MOUSE_BTNS_AND_CODES)

...
namespace Gothic_I_Classic {
  ...
  class zCTree {
  public:
    zMEMPOOL_DECLARATION_TEMPLATE( zCTree, 0x00873624 )
    ...
    void zCTree_OnInit()             zCall( 0x005823B0 );
    zCTree()                         zInit( zCTree_OnInit() );
    ~zCTree()                        zCall( 0x005823D0 );
    void RemoveChild()               zCall( 0x00582BC0 );
    zCTree* AddChild( T* item )      zCall( 0x005F9E40 );
    zCTree* AddChild( zCTree* node ) zCall( 0x005DA5F0 );
    int CountNodes()                 zCall( 0x005F9EA0 );
    void RemoveSubtree()             zCall( 0x005DA3D0 );
  ...
  class zCList {
  public:
    zMEMPOOL_DECLARATION_TEMPLATE( zCList, 0x00873640 );

    T* data;
    zCList* next;

    ~zCList()                             zCall( 0x004205E0 );
    void DeleteList()                     zCall( 0x0061B320 );
    void DeleteListDatas()                zCall( 0x00689220 );
    void Insert( T* ins )                 zCall( 0x00461EB0 );
    void InsertFront( T* ins )            zCall( 0x0046ACC0 );
    void Remove( T* rem )                 zCall( 0x00461F10 );
    T* Get( const int nr ) const          zCall( 0x00420750 );
    int GetNumInList() const              zCall( 0x00420610 );
    int GetNum() const                    zCall( 0x00420610 );
    T* operator [] ( const int nr ) const zCall( 0x00420750 );

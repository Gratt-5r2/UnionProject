...
namespace Gothic_II_Addon {
  ...
  static zCOLOR& NPC_COLOR_TALK_PC  = *(zCOLOR*)0x00AB1FDC;
  static zCOLOR& NPC_COLOR_TALK_NPC = *(zCOLOR*)0x00AB1E90;
  static zCOLOR& NPC_COLOR_NOISE    = *(zCOLOR*)0x00AB1EAC;
  ...
  public:
    ...
    zCView( int a0, int a1, int a2, int a3, zTviewID a4 = VIEW_ITEM ) : zCtor( zCViewBase ), zCtor( zCInputCallback ) zInit( zCView_OnInit( a0, a1, a2, a3, a4 ));

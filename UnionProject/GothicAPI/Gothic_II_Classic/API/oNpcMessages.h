...
namespace Gothic_II_Classic {
  ...
  public:
    ...
    zDefineInheritableCtor( oCNpcMessage ) : zCtor( zCEventMessage ) {}
    void oCNpcMessage_OnInit()               zCall( 0x00705880 );
    oCNpcMessage() : zCtor( zCEventMessage ) zInit( oCNpcMessage_OnInit() );
  ...
  public:
    ...
    oCMsgDamage() : zCtor( oCNpcMessage )                                                         zInit( oCMsgDamage_OnInit() );
    oCMsgDamage( TDamageSubType a0 ) : zCtor( oCNpcMessage )                                      zInit( oCMsgDamage_OnInit( a0 ));
    oCMsgDamage( TDamageSubType a0, oCNpc::oSDamageDescriptor const& a1 ) : zCtor( oCNpcMessage ) zInit( oCMsgDamage_OnInit( a0, a1 ));
  ...
  public:
    ...
    oCMsgWeapon() : zCtor( oCNpcMessage )                                    zInit( oCMsgWeapon_OnInit() );
    oCMsgWeapon( TWeaponSubType a0, int a1, int a2 ) : zCtor( oCNpcMessage ) zInit( oCMsgWeapon_OnInit( a0, a1, a2 ));
  ...
  public:
    ...
    oCMsgMovement() : zCtor( oCNpcMessage )                                         zInit( oCMsgMovement_OnInit() );
    oCMsgMovement( TMovementSubType a0, zSTRING const& a1 ) : zCtor( oCNpcMessage ) zInit( oCMsgMovement_OnInit( a0, a1 ));
    oCMsgMovement( TMovementSubType a0, zCVob* a1 ) : zCtor( oCNpcMessage )         zInit( oCMsgMovement_OnInit( a0, a1 ));
    oCMsgMovement( TMovementSubType a0, zVEC3 const& a1 ) : zCtor( oCNpcMessage )   zInit( oCMsgMovement_OnInit( a0, a1 ));
    oCMsgMovement( TMovementSubType a0, float a1 ) : zCtor( oCNpcMessage )          zInit( oCMsgMovement_OnInit( a0, a1 ));
    oCMsgMovement( TMovementSubType a0, int a1 ) : zCtor( oCNpcMessage )            zInit( oCMsgMovement_OnInit( a0, a1 ));
  ...
  public:
    ...
    oCMsgAttack() : zCtor( oCNpcMessage )                                         zInit( oCMsgAttack_OnInit() );
    oCMsgAttack( TAttackSubType a0, int a1, int a2 ) : zCtor( oCNpcMessage )      zInit( oCMsgAttack_OnInit( a0, a1, a2 ));
    oCMsgAttack( TAttackSubType a0, zCVob* a1, float a2 ) : zCtor( oCNpcMessage ) zInit( oCMsgAttack_OnInit( a0, a1, a2 ));
  ...
  public:
    ...
    oCMsgUseItem() : zCtor( oCNpcMessage )                                zInit( oCMsgUseItem_OnInit() );
    oCMsgUseItem( TUseItemSubType a0, zCVob* a1 ) : zCtor( oCNpcMessage ) zInit( oCMsgUseItem_OnInit( a0, a1 ));
  ...
  public:
    ...
    oCMsgState() : zCtor( oCNpcMessage )                                                      zInit( oCMsgState_OnInit() );
    oCMsgState( TStateSubType a0, float a1 ) : zCtor( oCNpcMessage )                          zInit( oCMsgState_OnInit( a0, a1 ));
    oCMsgState( TStateSubType a0, int a1 ) : zCtor( oCNpcMessage )                            zInit( oCMsgState_OnInit( a0, a1 ));
    oCMsgState( TStateSubType a0, int a1, int a2, zSTRING const& a3 ) : zCtor( oCNpcMessage ) zInit( oCMsgState_OnInit( a0, a1, a2, a3 ));
  ...
  public:
    ...
    oCMsgManipulate() : zCtor( oCNpcMessage )                                                              zInit( oCMsgManipulate_OnInit() );
    oCMsgManipulate( TManipulateSubType a0 ) : zCtor( oCNpcMessage )                                       zInit( oCMsgManipulate_OnInit( a0 ));
    oCMsgManipulate( TManipulateSubType a0, zCVob* a1 ) : zCtor( oCNpcMessage )                            zInit( oCMsgManipulate_OnInit( a0, a1 ));
    oCMsgManipulate( TManipulateSubType a0, int a1 ) : zCtor( oCNpcMessage )                               zInit( oCMsgManipulate_OnInit( a0, a1 ));
    oCMsgManipulate( TManipulateSubType a0, zSTRING const& a1, int a2 ) : zCtor( oCNpcMessage )            zInit( oCMsgManipulate_OnInit( a0, a1, a2 ));
    oCMsgManipulate( TManipulateSubType a0, zCVob* a1, int a2 ) : zCtor( oCNpcMessage )                    zInit( oCMsgManipulate_OnInit( a0, a1, a2 ));
    oCMsgManipulate( TManipulateSubType a0, zSTRING const& a1, zSTRING const& a2 ) : zCtor( oCNpcMessage ) zInit( oCMsgManipulate_OnInit( a0, a1, a2 ));
  ...
  public:
    ...
    oCMsgConversation() : zCtor( oCNpcMessage )                                                                zInit( oCMsgConversation_OnInit() );
    oCMsgConversation( TConversationSubType a0 ) : zCtor( oCNpcMessage )                                       zInit( oCMsgConversation_OnInit( a0 ));
    oCMsgConversation( TConversationSubType a0, zSTRING const& a1 ) : zCtor( oCNpcMessage )                    zInit( oCMsgConversation_OnInit( a0, a1 ));
    oCMsgConversation( TConversationSubType a0, zSTRING const& a1, zSTRING const& a2 ) : zCtor( oCNpcMessage ) zInit( oCMsgConversation_OnInit( a0, a1, a2 ));
    oCMsgConversation( TConversationSubType a0, zCVob* a1 ) : zCtor( oCNpcMessage )                            zInit( oCMsgConversation_OnInit( a0, a1 ));
    oCMsgConversation( TConversationSubType a0, int a1 ) : zCtor( oCNpcMessage )                               zInit( oCMsgConversation_OnInit( a0, a1 ));
    oCMsgConversation( TConversationSubType a0, int a1, int a2, float a3 ) : zCtor( oCNpcMessage )             zInit( oCMsgConversation_OnInit( a0, a1, a2, a3 ));
  ...
  public:
    ...
    oCMsgMagic() : zCtor( oCNpcMessage )                                          zInit( oCMsgMagic_OnInit() );
    oCMsgMagic( TConversationSubType a0 ) : zCtor( oCNpcMessage )                 zInit( oCMsgMagic_OnInit( a0 ));
    oCMsgMagic( TConversationSubType a0, int a1, int a2 ) : zCtor( oCNpcMessage ) zInit( oCMsgMagic_OnInit( a0, a1, a2 ));
  ...
  public:
    ...
    oCMsgRequest() : zCtor( oCNpcMessage ) {}

...
#ifndef __ZALGEBRA_H__VER2__
#define __ZALGEBRA_H__VER2__
...
#undef ROWCOL
  ...
  public:
    ...
    zMAT4 Inverse()                   zCall( 0x00512730 );
    void MakeOrthonormal()            zCall( 0x00514560 );
    zMAT3 ExtractRotation() const     zCall( 0x00514420 );
    zVEC3 ExtractScaling() const      zCall( 0x005143A0 );
    void PostRotateX( float a0 )      zCall( 0x00514960 );
    void PostRotateY( float a0 )      zCall( 0x005149B0 );
    void PostRotateZ( float a0 )      zCall( 0x00514A00 );
    void PreScale( const zVEC3& a0 )  zCall( 0x00514A70 );
    void PostScale( const zVEC3& a0 ) zCall( 0x00514A50 );
    zVEC3 GetEulerAngles() const      zCall( 0x005135C0 );
    void SetByEulerAngles( zVEC3 )    zCall( 0x00513600 );
    zMAT4 TransposeLinTrafo() const   zCall( 0x005123B0 );
    zMAT4 InverseLinTrafo() const     zCall( 0x00512570 );
  ...
  public:
    ...
    void QuatToMatrix3( zMAT3& a0 ) const                                                          zCall( 0x00515690 );
    void Matrix3ToQuat( zMAT3& a0 )                                                                zCall( 0x00515A50 );
    void QuatToMatrix4( zMAT4& a0 ) const                                                          zCall( 0x00515590 );
    void Matrix4ToQuat( zMAT4& a0 )                                                                zCall( 0x00515790 );
    void QuatToEuler( zVEC3& a0) const                                                             zCall( 0x00515CF0 );
    void EulerToQuat( const zVEC3& a0 )                                                            zCall( 0x00515E10 );
    void QuatToAxisAngle( zVEC3& a0, float& a1 ) const                                             zCall( 0x00515EC0 );
    void Slerp( float a0, const zCQuat& a1, const zCQuat& a2 )                                     zCall( 0x00515F40 );
    void Lerp( float a0, const zCQuat& a1, const zCQuat& a2 )                                      zCall( 0x00516120 );
    void Squad( float a0, const zCQuat& a1, const zCQuat& a2, const zCQuat& a3, const zCQuat& a4 ) zCall( 0x00516220 );
  ...
  public:
    ...
    void zCValueSmooth_OnInit() zCall( 0x005163E0 );
    zCValueSmooth()             zInit( zCValueSmooth_OnInit() );
    void Smooth( float& )       zCall( 0x00516400 );
  ...
  public:
    ...
    void zCVEC3Smooth_OnInit() zCall( 0x00516460 );
    zCVEC3Smooth()             zInit( zCVEC3Smooth_OnInit() );
    void Smooth( zVEC3& )      zCall( 0x005164E0 );

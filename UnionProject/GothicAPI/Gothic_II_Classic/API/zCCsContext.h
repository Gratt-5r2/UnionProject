...
#ifndef __ZCCS_CONTEXT_H__VER2__
#define __ZCCS_CONTEXT_H__VER2__
...
namespace Gothic_II_Classic {
  ...
  public:
    ...
    zCCSCutsceneContext() : zCtor( zCCutscene )                                zInit( zCCSCutsceneContext_OnInit() );
    zCCSCutsceneContext( zSTRING& a0 ) : zCtor( zCCutscene )                   zInit( zCCSCutsceneContext_OnInit( a0 ));
    zCCSCutsceneContext( zCCSBlock* a0, int a1, int a2 ) : zCtor( zCCutscene ) zInit( zCCSCutsceneContext_OnInit( a0, a1, a2 ));
  ...
  public:
    ...
    zDefineInheritableCtor( zCCSDebugger ) {}
    zCCSDebugger() {}
    virtual ~zCCSDebugger()                               zCall( 0x0041EDB0 );

...
namespace Gothic_II_Classic {
  ...
  public:
    ...
    zSTRING worldFilename;             // sizeof 14h    offset 6254h
    zSTRING worldName;                 // sizeof 14h    offset 6268h
    zCListSort<zCVob>* voblist;        // sizeof 04h    offset 627Ch
    zCListSort<oCNpc>* voblist_npcs;   // sizeof 04h    offset 6280h
    zCListSort<oCItem>* voblist_items; // sizeof 04h    offset 6284h

...
namespace Gothic_II_Classic {
  ...
  public:
    ...
    zDefineInheritableCtor( zCViewProgressBar ) : zCtor( zCView ) {}
    zCViewProgressBar() : zCtor( zCView ) {}
    void zCViewProgressBar_OnInit( int, int, int, int, zTviewID )                      zCall( 0x0046DDA0 );
    zCViewProgressBar( int a0, int a1, int a2, int a3, zTviewID a4 ) : zCtor( zCView ) zInit( zCViewProgressBar_OnInit( a0, a1, a2, a3, a4 ));

...
namespace Gothic_I_Addon {
  ...
  class zCTree {
  public:
    zMEMPOOL_DECLARATION_TEMPLATE( zCTree, 0x008B92F0 )
    ...
    void zCTree_OnInit()             zCall( 0x0059CEC0 );
    zCTree()                         zInit( zCTree_OnInit() );
    ~zCTree()                        zCall( 0x0059CEE0 );
    void RemoveChild()               zCall( 0x0059D700 );
    zCTree* AddChild( T* item )      zCall( 0x0061B3A0 );
    zCTree* AddChild( zCTree* node ) zCall( 0x005F9EE0 );
    int CountNodes()                 zCall( 0x0061B400 );
    void RemoveSubtree()             zCall( 0x005F9D50 );
  ...
  class zCList {
  public:
    zMEMPOOL_DECLARATION_TEMPLATE( zCList, 0x008B9310 );

    T* data;
    zCList* next;

    ~zCList()                             zCall( 0x0061B820 );
    void DeleteList()                     zCall( 0x0063E9E0 );
    void DeleteListDatas()                zCall( 0x00654F20 );
    void Insert( T* ins )                 zCall( 0x0069E3C0 );
    void InsertFront( T* ins )            zCall( 0x004722A0 );
    void Remove( T* rem )                 zCall( 0x0073D3A0 );
    T* Get( const int nr ) const          zCall( 0x00422B00 );
    int GetNumInList() const              zCall( 0x006B95F0 );
    int GetNum() const                    zCall( 0x006B95F0 );
    T* operator [] ( const int nr ) const zCall( 0x00422B00 );

...
namespace Gothic_I_Addon {
  ...
  public:
    ...
    public:
      ...
      float fAzimuth;                                      // sizeof 04h    offset 8Ch
      float fElevation;                                    // sizeof 04h    offset 90h
      float fTimeCurrent;                                  // sizeof 04h    offset 94h
      float fDamageReal;                                   // sizeof 04h    offset 98h
      float fDamageEffective;                              // sizeof 04h    offset 9Ch
      unsigned long aryDamageEffective[oEDamageIndex_MAX]; // sizeof 20h    offset A0h
      zCVob* pVobParticleFX;                               // sizeof 04h    offset C0h
      zCParticleFX* pParticleFX;                           // sizeof 04h    offset C4h
      oCVisualFX* pVisualFX;                               // sizeof 04h    offset C8h
    ...
    group {
      ...
      zSTRING name[5];                            // sizeof 64h    offset 104h
      zSTRING slot;                               // sizeof 14h    offset 168h
      int npcType;                                // sizeof 04h    offset 17Ch
      int variousFlags;                           // sizeof 04h    offset 180h
      int attribute[NPC_ATR_MAX];                 // sizeof 20h    offset 184h
      int protection[oEDamageIndex_MAX];          // sizeof 20h    offset 1A4h
      int damage[oEDamageIndex_MAX];              // sizeof 20h    offset 1C4h
      int damagetype;                             // sizeof 04h    offset 1E4h
      int guild;                                  // sizeof 04h    offset 1E8h
      int level;                                  // sizeof 04h    offset 1ECh
      int mission[NPC_MIS_MAX];                   // sizeof 14h    offset 1F0h
      int fighttactic;                            // sizeof 04h    offset 204h
      int fmode;                                  // sizeof 04h    offset 208h
      int voice;                                  // sizeof 04h    offset 20Ch
      int voicePitch;                             // sizeof 04h    offset 210h
      int mass;                                   // sizeof 04h    offset 214h
      int daily_routine;                          // sizeof 04h    offset 218h
      int startAIState;                           // sizeof 04h    offset 21Ch
      zSTRING spawnPoint;                         // sizeof 14h    offset 220h
      int spawnDelay;                             // sizeof 04h    offset 234h
      int senses;                                 // sizeof 04h    offset 238h
      int senses_range;                           // sizeof 04h    offset 23Ch
      int aiscriptvars[50];                       // sizeof C8h    offset 240h
      zSTRING wpname;                             // sizeof 14h    offset 308h
      unsigned long experience_points;            // sizeof 04h    offset 31Ch
      unsigned long experience_points_next_level; // sizeof 04h    offset 320h
      unsigned long learn_points;                 // sizeof 04h    offset 324h
      int parserEnd;                              // sizeof 04h    offset 328h
    };
    int bloodEnabled;                             // sizeof 04h    offset 32Ch
    int bloodDistance;                            // sizeof 04h    offset 330h
    int bloodAmount;                              // sizeof 04h    offset 334h
    int bloodFlow;                                // sizeof 04h    offset 338h
    zSTRING bloodEmitter;                         // sizeof 14h    offset 33Ch
    zSTRING bloodTexture;                         // sizeof 14h    offset 350h
    int didHit;                                   // sizeof 04h    offset 364h
    int didParade;                                // sizeof 04h    offset 368h
    int didShoot;                                 // sizeof 04h    offset 36Ch
    int hasLockedEnemy;                           // sizeof 04h    offset 370h
    int isDefending;                              // sizeof 04h    offset 374h
    int wasAiming;                                // sizeof 04h    offset 378h
    oCNpc* enemy;                                 // sizeof 04h    offset 37Ch
    float speedTurn;                              // sizeof 04h    offset 380h
    int foundFleePoint;                           // sizeof 04h    offset 384h
    int reachedFleePoint;                         // sizeof 04h    offset 388h
    zVEC3 vecFlee;                                // sizeof 0Ch    offset 38Ch
    zVEC3 posFlee;                                // sizeof 0Ch    offset 398h
    zCWaypoint* waypointFlee;                     // sizeof 04h    offset 3A4h
    oTRobustTrace rbt;                            // sizeof 9Ch    offset 3A8h
    zCList<oCNpcTimedOverlay> timedOverlays;      // sizeof 08h    offset 444h
    zCArray<oCNpcTalent*> talents;                // sizeof 0Ch    offset 44Ch
    int spellMana;                                // sizeof 04h    offset 458h
    oCVisualFX* visualFX;                         // sizeof 04h    offset 45Ch
    oCMagFrontier magFrontier;                    // sizeof 10h    offset 460h
    oCNpc_States state;                           // sizeof E0h    offset 470h
    oCNpcInventory inventory2;                    // sizeof 234h   offset 550h
    oCItemContainer* trader;                      // sizeof 04h    offset 784h
    oCNpc* tradeNpc;                              // sizeof 04h    offset 788h
    float rangeToPlayer;                          // sizeof 04h    offset 78Ch
    zCArray<int> listOfVoiceHandles;              // sizeof 0Ch    offset 790h
    int voiceIndex;                               // sizeof 04h    offset 79Ch
    ...
    int instanz;                                  // sizeof 04h    offset 7B4h
    zSTRING mds_name;                             // sizeof 14h    offset 7B8h
    zSTRING body_visualName;                      // sizeof 14h    offset 7CCh
    zSTRING head_visualName;                      // sizeof 14h    offset 7E0h
    zVEC3 model_scale;                            // sizeof 0Ch    offset 7F4h
    float model_fatness;                          // sizeof 04h    offset 800h
    int namenr;                                   // sizeof 04h    offset 804h
    float hpHeal;                                 // sizeof 04h    offset 808h
    float manaHeal;                               // sizeof 04h    offset 80Ch
    float swimtime;                               // sizeof 04h    offset 810h
    float divetime;                               // sizeof 04h    offset 814h
    float divectr;                                // sizeof 04h    offset 818h
    zCVob* fireVob;                               // sizeof 04h    offset 81Ch
    int fireDamage;                               // sizeof 04h    offset 820h
    float fireDamageTimer;                        // sizeof 04h    offset 824h
    int attitude;                                 // sizeof 04h    offset 828h
    int tmp_attitude;                             // sizeof 04h    offset 82Ch
    float attTimer;                               // sizeof 04h    offset 830h
    int knowsPlayer;                              // sizeof 04h    offset 834h
    TNpcPerc percList[NPC_PERC_MAX];              // sizeof 108h   offset 838h
    int percActive;                               // sizeof 04h    offset 940h
    float percActiveTime;                         // sizeof 04h    offset 944h
    float percActiveDelta;                        // sizeof 04h    offset 948h
    int overrideFallDownHeight;                   // sizeof 04h    offset 94Ch
    float fallDownHeight;                         // sizeof 04h    offset 950h
    int fallDownDamage;                           // sizeof 04h    offset 954h
    oCMag_Book* mag_book;                         // sizeof 04h    offset 958h
    zCList<oCSpell> activeSpells;                 // sizeof 08h    offset 95Ch
    zCArray<zSTRING> activeOverlays;              // sizeof 0Ch    offset 964h
    oCAskBox* askbox;                             // sizeof 04h    offset 970h
    int askYes;                                   // sizeof 04h    offset 974h
    int askNo;                                    // sizeof 04h    offset 978h
    float canTalk;                                // sizeof 04h    offset 97Ch
    oCNpc* talkOther;                             // sizeof 04h    offset 980h
    oCInfo* info;                                 // sizeof 04h    offset 984h
    oCNews* news;                                 // sizeof 04h    offset 988h
    oCMission* curMission;                        // sizeof 04h    offset 98Ch
    oCNewsMemory knownNews;                       // sizeof 0Ch    offset 990h
    zCVob* carry_vob;                             // sizeof 04h    offset 99Ch
    oCMobInter* interactMob;                      // sizeof 04h    offset 9A0h
    oCItem* interactItem;                         // sizeof 04h    offset 9A4h
    int interactItemCurrentState;                 // sizeof 04h    offset 9A8h
    int interactItemTargetState;                  // sizeof 04h    offset 9ACh
    int slotItemsCreated;                         // sizeof 04h    offset 9B0h
    int script_aiprio;                            // sizeof 04h    offset 9B4h
    int old_script_state;                         // sizeof 04h    offset 9B8h
    oCAIHuman* human_ai;                          // sizeof 04h    offset 9BCh
    oCAniCtrl_Human* anictrl;                     // sizeof 04h    offset 9C0h
    zCRoute* route;                               // sizeof 04h    offset 9C4h
    float damageMul;                              // sizeof 04h    offset 9C8h
    oCNpcMessage* csg;                            // sizeof 04h    offset 9CCh
    oCNpcMessage* lastLookMsg;                    // sizeof 04h    offset 9D0h
    oCNpcMessage* lastPointMsg;                   // sizeof 04h    offset 9D4h
    zCArray<zCVob*> vobList;                      // sizeof 0Ch    offset 9D8h
    float vobcheck_time;                          // sizeof 04h    offset 9E4h
    float pickvobdelay;                           // sizeof 04h    offset 9E8h
    zCVob* focus_vob;                             // sizeof 04h    offset 9ECh
    zCArray<TNpcSlot*> invSlot;                   // sizeof 0Ch    offset 9F0h
    zCArray<TNpcSlot*> tmpSlotList;               // sizeof 0Ch    offset 9FCh
    float fadeAwayTime;                           // sizeof 04h    offset A08h
    float respawnTime;                            // sizeof 04h    offset A0Ch
    float selfDist;                               // sizeof 04h    offset A10h
    int fightRangeBase;                           // sizeof 04h    offset A14h
    int fightRangeFist;                           // sizeof 04h    offset A18h
    float fight_waitTime;                         // sizeof 04h    offset A1Ch
    int fight_waitForAniEnd;                      // sizeof 04h    offset A20h
    float fight_lastStrafeFrame;                  // sizeof 04h    offset A24h
    int soundType;                                // sizeof 04h    offset A28h
    zCVob* soundVob;                              // sizeof 04h    offset A2Ch

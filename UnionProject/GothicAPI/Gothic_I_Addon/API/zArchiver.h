...
namespace Gothic_I_Addon {
  ...
  public:
    ...
    zCArchiverFactory() {}
    int EndOfArchive( zCBuffer*, zFILE* )                                              zCall( 0x0051E2F0 );
    void ReadLine( zSTRING&, zCBuffer*, zFILE* )                                       zCall( 0x0051E360 );
    void ReadLineArg( zSTRING&, zSTRING&, zCBuffer*, zFILE* )                          zCall( 0x0051E580 );
    void ReadHeader( int, zCBuffer*, zFILE*, zCArchiver*&, zTArchiveMode&, int& )      zCall( 0x0051E840 );
    void WriteLine( zSTRING const&, zCBuffer*, zFILE* )                                zCall( 0x0051F120 );
    void WriteLine( char const* const, zCBuffer*, zFILE* )                             zCall( 0x0051F230 );
    void WriteHeader( zCArchiver*, zTArchiveMode, int, int, zCBuffer*, zFILE* )        zCall( 0x0051F340 );
    zCArchiver* CreateArchiverFromMode( zTArchiveMode )                                zCall( 0x0051FA70 );
    virtual zCArchiver* CreateArchiverRead( zCBuffer*, int )                           zCall( 0x0051EE60 );
    virtual zCArchiver* CreateArchiverRead( zFILE*, int )                              zCall( 0x0051EEF0 );
    virtual zCArchiver* CreateArchiverRead( zSTRING const&, int )                      zCall( 0x0051EF60 );
    virtual zCArchiver* CreateArchiverWrite( zCBuffer*, zTArchiveMode, int, int )      zCall( 0x0051FB80 );
    virtual zCArchiver* CreateArchiverWrite( zTArchiveMode, int, int )                 zCall( 0x0051FD10 );
    virtual zCArchiver* CreateArchiverWrite( zFILE*, zTArchiveMode, int, int )         zCall( 0x0051FDB0 );
    virtual zCArchiver* CreateArchiverWrite( zSTRING const&, zTArchiveMode, int, int ) zCall( 0x0051FD30 );
  ...
  public:
    ...
    struct zTChunkRecord {
      ...
      zTChunkRecord& operator =( zTChunkRecord const& ) zCall( 0x00524510 );
    ...
    virtual ~zCArchiver()                                                                              zCall( 0x00520C40 );
    ...
    virtual zCObject* __fastcall ReadObjectAccount( char const*, int, zCObject* )                      zCall( 0x0051FE00 );
    virtual zCObject* __fastcall ReadObjectAccount( char const*, int, char const*, zCObject* )         zCall( 0x0051FE30 );
